...
public class ConfigEntity {
	...
	public static final String DEFAULT_NO_AMMO_SOUND = Sound.BLOCK_DISPENSER_FAIL.name();
	public static final String NO_AMMO_SOUND_JSON_TAG = "no_ammo_sound";
	...
	private String noAmmoSound = DEFAULT_NO_AMMO_SOUND;
	...
	/**
	 * Gets the sound played when a weapon has no ammo.
	 */
	...
	/**
	 * Sets the sound played when a weapon has no ammo.
	 */
	 ...
	 * Sets the sound played when a weapon has no ammo.
	 */
	public void setNoAmmoSound(Sound noAmmoSound) {
		this.noAmmoSound = noAmmoSound.name();
	}
