...
public class ConfigEntity {
	...
	public static final String AUTO_GENERATE_DEFAULT_ENEMIES_JSON_TAG = "autoGenerateDefaultEnemies";
	public static final String AUTO_GENERATE_DEFAULT_PERKS_JSON_TAG = "autoGenerateDefaultPerks";
	public static final String AUTO_GENERATE_DEFAULT_WEAPONS_JSON_TAG = "autoGenerateDefaultWeapons";
	public static final String AUTO_SAVE_TIMER_INTERVAL_JSON_TAG = "autoSaveTimerInterval";
	public static final String ENABLE_DEBUGGING_JSON_TAG = "enableDebugging";
	public static final String POSITION_TOOL_ITEM_JSON_TAG = "positionToolItem";
	public static final String SPAWNING_TOOL_ITEM_JSON_TAG = "spawningToolItem";
	//endregion
